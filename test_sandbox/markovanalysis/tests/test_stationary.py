...
from markovanalysis import getStationaryDistribution, getStationaryDistributionLimit
import numpy as np
...
def Test_B():
    """Testing the the getStationaryDistributionLimit function"""
    tr_matrix = np.array([
        [0.5, 0.2, 0.2, 0.1],
        [0.5, 0.1, 0.2, 0.2],
        [0.1, 0.2, 0.3, 0.4],
        [0.2, 0.3, 0.4, 0.1]], dtype=np.float64)
    pi = getStationaryDistributionLimit(tr_matrix)
